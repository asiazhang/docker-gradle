...
```bash
docker run --rm -v /path/to/your/project:/usr/src/app:rw -v /root/.gradle/caches:/root/.gradle/caches asiazhang/gradle build
```
...
```bash
docker run --rm -p 8080:8080 -v /path/to/your/project:/usr/src/app:rw -v /root/.gradle/caches:/root/.gradle/caches asiazhang/gradle jettyRunWar
```
